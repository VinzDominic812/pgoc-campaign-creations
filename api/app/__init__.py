...
from routes.verify_page_name_routes import verify_page_name_bp
...
from routes.on_off_page_routes import pagename_on_off
...
def create_app():
    ...
    # Get allowed origins from .env and convert them into a list
    allowed_origins = os.getenv("ALLOWED_ORIGINS", "").split(",")

    # Allow CORS for the specific frontend origin
    CORS(app, resources={r"/api/*": {"origins": allowed_origins[0]}})
