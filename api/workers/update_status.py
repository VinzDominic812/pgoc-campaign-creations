    ...
    try:
        ...
        for campaign_id, campaign_info in campaigns_data.items():
            ...
            if what_to_watch == "campaigns":
                ...
                if (on_off == "ON" and campaign_cpp < cpp_metric and campaign_cpp > 0) or (on_off == "OFF" and campaign_cpp >= cpp_metric):
                ...
                for adset_id, adset_info in campaign_info.get("ADSETS", {}).items():
                    ...
                    if (on_off == "ON" and adset_cpp < cpp_metric and adset_cpp > 0) or (on_off == "OFF" and adset_cpp >= cpp_metric):
